...
const slides = [
  {
    ...
    description:
      'Take control with CozyCast! Setup feeds by clicking the filter icon.',
  ...
  },
  {
    ...
    description:
      'Want to view casts from OGs? Filter your feed with Custom Fids.',
...
export default function IndexScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {farcasterUser ? (
        <FeedComponent fid={farcasterUser.fid} />
      ) : !login ? (
        <AppIntroSlider
          data={slides}
          renderItem={({ item }) => {
